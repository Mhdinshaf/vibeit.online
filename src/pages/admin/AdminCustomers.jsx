                ...
                <div key={c._id} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <div className="min-w-0">
                      {editingId === c._id ? (
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 break-all">{c.email}</p>
                        </div>
                      )}
                    </div>
                        ...
                        <>
                          <button
                            ...
                            className={`p-2 rounded-lg transition-colors ${
                              expandedId === c._id ? 'bg-blue-100 text-blue-700' : 'text-slate-400 hover:bg-slate-100'
                            }`}
                            title="View orders"
                          >
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3 text-xs text-slate-600">
                    <div>
                      ...
                      {editingId === c._id ? (
                        <input
                          ...
                          className="mt-1 w-full border border-slate-300 rounded-lg px-2 py-1 text-sm"
                        />
                      ) : (
                    ...
                    <div>
                      ...
                      <p className="font-medium text-slate-700">{c.totalOrders ?? 0}</p>
                    </div>
                    <div>
                      <p className="text-slate-400">Delivered</p>
                      <p className="font-medium text-emerald-700">{c.deliveredOrders ?? 0}</p>
                    </div>
                    <div>
                      <p className="text-slate-400">Reseller</p>
                      {editingId === c._id ? (
                        <label className="mt-1 inline-flex items-center gap-2 text-xs font-semibold text-slate-600">
                          <input
                            type="checkbox"
                  ...
                  {expandedId === c._id && (
                    <div className="mt-4">
                      <CustomerOrdersPanel customerId={c._id} isApiConnected={isApiConnected} />
                    </div>
                  )}
                </div>
              ))}
