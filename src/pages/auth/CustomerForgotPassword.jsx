    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center px-4 py-10 sm:py-12 overflow-x-clip">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">We will email you a secure link to reset your password.</p>
        </div>
          ...
          {!submitted ? (
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="btn-outline w-full py-2.5 px-4 text-sm"
              >
                Send another email
              </button>
            </div>
          ...
          {!submitted && (
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400">Remembered your password?</span>
              </div>
            </div>
          )}
