...
const AboutPage = () => {
  return (
    <div className="bg-white dark:bg-[#050b18] overflow-x-clip transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <article key={stat.label} className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5 shadow-sm">
                <p className="text-2xl sm:text-3xl font-semibold text-slate-900 dark:text-white">{stat.number}</p>
      ...
      <section className="py-12 sm:py-16 border-y border-slate-200 dark:border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <article key={value.title} className="rounded-2xl border border-slate-200 dark:border-slate-700 p-6 bg-transparent">
                <div className="w-11 h-11 rounded-xl bg-slate-900 text-white flex items-center justify-center">
                  <value.icon className="w-5 h-5" />
                </div>
                <h3 className="mt-5 text-xl font-semibold text-slate-900 dark:text-white">{value.title}</h3>
                <p className="mt-2 text-slate-600 dark:text-slate-300">{value.desc}</p>
              </article>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <article key={feature.title} className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 shadow-sm">
                <div className="w-11 h-11 rounded-xl bg-slate-900 text-white flex items-center justify-center">
