    ...
    <div className="bg-slate-50 overflow-x-clip transition-colors">
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16 text-center">
          <p className="text-xs uppercase tracking-[0.16em] font-bold text-slate-500 mb-3">About us</p>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-slate-900">Built for modern shopping in Sri Lanka</h1>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-900">The Vibe of Online Shopping</h2>
            ...
            <Link
              to="/shop"
              className="mt-7 inline-flex items-center gap-2 rounded-md bg-blue-600 px-6 py-3.5 text-white font-bold hover:bg-blue-700 transition-colors uppercase tracking-wider text-sm"
            >
              Explore products
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <article key={stat.label} className="rounded-md border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-1 text-sm font-semibold text-slate-500 uppercase tracking-wider">{stat.label}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 border-y border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-900">Our Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <article key={value.title} className="rounded-md border border-slate-200 p-6 bg-slate-50">
                ...
                <p className="mt-2 text-slate-600 text-sm leading-relaxed">{value.desc}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-900">Why customers choose us</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <article key={feature.title} className="rounded-md border border-slate-200 bg-white p-6 shadow-sm text-center">
